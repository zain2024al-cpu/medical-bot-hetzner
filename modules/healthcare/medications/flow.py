...
# Medication dispensing — official 9-step operational workflow.
#
...
#   6. ملاحظات          — text input (optional)
#   7. اسم الصحي        — fixed 3-name single-select callback (REQUIRED, no skip)
#   8. مراجعة نهائية   — review screen
#   9. نشر             — DB save + publish
...
from modules.healthcare.medications.constants import SP_MAP, DEPT_OTHER_ID
...
from modules.healthcare.medications.views import (
    ...
    build_count_prompt, build_notes_prompt, build_specialist_prompt,
