...
# ── Staff (specialist) ────────────────────────────────────────────────────────
# ✅ لم تعد قائمة ثابتة هنا. قائمة المختصين تُشتَقّ الآن من **الصلاحيات**
# (من مُنح وحدة "general_services" من إدارة الوصول) — انظر
# modules/general_services/staff.py::get_staff_map.
#
# كانت `STAFF_MAP` قاموساً باسمين مكتوبين في الكود ("رضاء"، "علي صالح")،
# فأي موظف جديد يستلزم تعديل الكود ونشراً، وأي موظف يغادر يبقى اسمه
# ظاهراً. الآن: الموافقة على الطلب + كتابة الاسم + فتح صلاحية الخدمات
# العامة ⇒ يظهر الاسم تلقائياً، وسحب الصلاحية يُخفيه.
