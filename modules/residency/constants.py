...
RESIDENCY_STATUS_LABELS: dict[str, str] = {
    ...
    "expired":            "❌ منتهية",
    "inactive":           "🔒 غير نشطة",
    # ✅ ملف قادم من "🛬 الوصول" ولم تُرفَع له الصورة الشخصية وفورم C بعد —
    # الحالة الابتدائية الجديدة (بدل "active" مباشرة) لملفات الوصول من الآن
    # فصاعداً فقط (لا تُعاد كتابتها على الملفات الموجودة مسبقاً).
    "pending_documents":  "📋 بانتظار الصورة/فورم C",
    # ✅ اعتماد يدوي صريح (زر "✅ اعتماد ونقل إلى الأرشيف") بعد اكتمال
    # الصورة الشخصية وفورم C — لا تلقائي بمجرد الرفع.
    "archived":           "🗄️ مؤرشفة",
}
