...
# قرار المستخدم: كل شيء عبر «📁 أرشيف المرضى» ← ملف المريض مباشرة. متابعة
# مرحلة الأوراق (`PAPERS_ADVANCE`) وفورم C والصورة الشخصية صارت كلها أزراراً
# على ملف المريض نفسه (`modules/residency/profiles/views.py`).
