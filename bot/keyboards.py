...
def admin_main_kb():
    ...
    keyboard = [
        ...
        # ملاحظة: زرّا "💰 التقرير المالي" و"🖨️ طباعة مسير الإخلاء" أُزيلا من
        # واجهة الأدمن فقط (بناءً على طلب صريح) — الأدمن حالياً لإدارة
        # الصلاحيات لا لاستخدامهما. الميزة كاملة ولم تُمَس: المعالِجات
        # والخدمات والصلاحيات والتسجيل في core/modules_bootstrap.py باقية،
        # ويظهر الزران للمستخدمين المخوَّلين عبر dynamic_user_kb() (سجل
        # الوحدات) بشكل مستقل تماماً عن هذه اللوحة.
