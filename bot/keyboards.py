...
def admin_main_kb():
    ...
    keyboard = [
        ...
        # ملاحظة: زرّا "💰 التقرير المالي" و"🖨️ طباعة مسير الإخلاء" غير
        # موجودين في الشاشة الرئيسية عمداً. الأول ما زال مقتصراً على
        # dynamic_user_kb() للمستخدمين المخوَّلين (لم يُطلَب للأدمن).
        # الثاني نُقل إلى شاشة "🛠️ إدارة النظام" (admin_system_menu.py)
        # بطلب صريح — لا يبقى في الشاشة الرئيسية.
