...
def ensure_default_translators():
    ...
    translator_names = [
        ...
        "زين العابدين",
        "عبدالسلام",
        # ⚠️ لا تُضِف هنا "ياسر" أو "يحيى" المختصرين: الاسمان الصحيحان هما
        # "ياسر ابو عمار" و"يحيى أبو حمزة" ووجود المختصر بجانبهما يسبّب خلطاً
        # عند اختيار المترجم. هذه القائمة تُزرَع في القاعدة عند **كل إقلاع**،
        # فأي اسم يُحذف من القاعدة ويبقى هنا يعود تلقائياً بصفّ جديد.
    ]
