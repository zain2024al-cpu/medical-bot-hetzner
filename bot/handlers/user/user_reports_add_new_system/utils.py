...
# ✅ ترتيب صحيح مطابق لـ firstweekday=SATURDAY: السبت، الأحد، الاثنين،
# الثلاثاء، الأربعاء، الخميس، الجمعة. (القيمة القديمة كانت خاطئة: تكرّر
# "س" وتُسقط الاثنين، فيظهر رأس التقويم بمسمّيات أيام مغلوطة.)
