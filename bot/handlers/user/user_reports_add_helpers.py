...
PREDEFINED_ACTIONS = [
    ...
    "المناظير",  # ✅ مسار المناظير (endoscopy)
    # ✅ مسارات "💉 جلسات العلاج" الجديدة (Treatment Plans)
    "العلاج الكيماوي",
    "العلاج الموجه",
    "العلاج المناعي",
    "جلسات غسيل الكلى",
    # ✅ يظهر حصراً في قسم "🏙️ الرعاية الصحية - تشناي" — مخفي عن قائمة
    # نوع الإجراء الاعتيادية (انظر action_type_handlers.py::_build_action_type_keyboard).
    "معاملة الزراعة",
]
