...
def register_all_handlers(app):
    ...
    # ✅ متابعة الإقامات للأدمن — عرض فقط (زر "🪪 متابعة الإقامات" داخل إدارة النظام)
    from bot.handlers.admin.admin_residency_monitor import register as register_residency_monitor
    register_residency_monitor(app)
    ...
    # ── Residency module (groups 16, 20: text/callback handlers)
    from modules.residency.routing import register_all as register_residency
    register_residency(app)
