...
def get_all_translator_names() -> List[str]:
    ...
    # ⚠️ الاسمان المختصران "يحيى" و"ياسر" أُزيلا من هنا: كانا يلتبسان
    # بالاسمين الصحيحين "يحيى ابو حمزه" و"ياسر ابو عمار". وُضع الاسم
    # الكامل بدلهما حتى يحتفظ المترجمان بموقعهما في الصفحة الأولى بعد
    # حذف المختصرين من قاعدة البيانات.
    priority_order = [
        "معتز", "ادم", "هاشم", "مصطفى", "حسن", "نجم الدين", "محمد علي",
        "صبري", "عزي", "سعيد", "عصام", "زيد", "مهدي", "ادريس",
        "واصل", "عزالدين", "عبدالسلام", "يحيى أبو حمزة", "ياسر ابو عمار"
    ]
